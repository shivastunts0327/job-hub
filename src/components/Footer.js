    ...
    return (
        <div className="footer-bg">
            ...
            <div className="footer-ending">
                <p>Copyright 2020</p>
                <div>
                    <Link to='/linkedin' className="fa"><i className="fab fa-linkedin"></i></Link>
                    <Link to='/twitter' className="fa"><i className="fab fa-twitter"></i></Link>
                    <Link to='/facebook' className="fa"><i className="fab fa-facebook"></i></Link>
                    <Link to='/facebook' className="fa"><i className="fab fa-instagram"></i></Link>
                    <Link to='/facebook' className="fa"><i className="fab fa-youtube"></i></Link>
                </div>
            </div>
        </div>
    );
